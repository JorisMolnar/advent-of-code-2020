/** Expected result: shiny gold: 32 other bags */
export const example: string = `light red bags contain 1 bright white bag, 2 muted yellow bags.
...
/** Expected result: shiny gold: 126 other bags */
export const example2: string = `shiny gold bags contain 2 dark red bags.
...
export const input: string = `vibrant salmon bags contain 1 vibrant gold bag, 2 wavy aqua bags, 1 dotted crimson bag.
