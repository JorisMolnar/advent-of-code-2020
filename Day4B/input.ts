/** Expexted result: 0 valid */
export const example1: string = `eyr:1972 cid:100
...
/** Expexted result: 4 valid */
export const example2: string = `pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
export const input: string = `byr:2010 pid:#1bb4d8 eyr:2021 hgt:186cm iyr:2020 ecl:grt
